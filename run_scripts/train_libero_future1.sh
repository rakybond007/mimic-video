#!/bin/bash
#SBATCH --job-name="MimicVideo-Future1"
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=rlwrld
#SBATCH --output=out/%j-mimic_video_future1.out
#SBATCH --error=out/%j-mimic_video_future1.err
...
CKPT_DIR=$WORK_DIR/checkpoints/libero_cosmos2_past8_future1_idx1
...
NUM_FRAMES=8
NUM_FUTURE_FRAMES=1
FUTURE_FRAME_START=1
RUN_NAME=cosmos2_frozen_lang_past8_future1_idx1
