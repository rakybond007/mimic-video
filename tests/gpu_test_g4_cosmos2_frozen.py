"""G4-Cosmos2-Frozen: Real LIBERO + real Cosmos 2.0 (frozen) + MimicVideo head only, 100 steps."""
import sys, os
...
OUTPUT_DIR = "/rlwrld3/home/hojin/vam_workspace/mimic-video/ckpt/g4_cosmos2_frozen"
...
print("\nStarting training (100 steps, video backbone FROZEN)...")
